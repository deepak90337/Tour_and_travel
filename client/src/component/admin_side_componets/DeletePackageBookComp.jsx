...
const DeletePackageBookComp = () => {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/packages/package-delete', {
        method: 'POST',
        headers: {
  ...
  useEffect(() => {
    ...
    height: '3rem',
      ...
      <div className="row justify-content-center">
        ...
        <h1 className="text-primary mb-4">Delete Package Booking</h1>
      <form>
      {showAlert && (
  ...
  <input type="text" name="useridn" className="form-control py-3" value={pId} onChange={handleIdChange} placeholder="User ID" />
  </div>
  </div>
...
export default DeletePackageBookComp;
