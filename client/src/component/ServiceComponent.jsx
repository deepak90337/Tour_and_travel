            ...
            >
              <div className="service-item rounded pt-3">
                <div className="p-4">
                  ...
                  <p>
                    Make your stay memorable with our convenient Hotel
                    Reservation service.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="service-item rounded pt-3">
                <div className="p-4">
                  ...
                  <h5>Travel Guides</h5>
                  <p>
                    Discover new cultures and experiences with our expert Travel
                    Guides.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="service-item rounded pt-3">
                <div className="p-4">
                  ...
                  <p>
                    Effortlessly manage your events with our Event Management
                    solutions.
                  </p>
                </div>
              </div>
